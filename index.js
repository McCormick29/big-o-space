...
function getNumbersSquared(numbers) {
  ...
  for (let i in numbers) {
    let square = numbers[i] * nubmers[i]
...
// ANSWER: 
// Both do the same thing at the same space complexity but at a different route
